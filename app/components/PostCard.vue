<template>
  <div
    class="bg-white rounded shadow-sm p-6 w-full max-w-[800px] border border-gray-100"
  >
    ...
    <div class="flex gap-6">
      <div class="w-full md:w-1/2 rounded overflow-hidden">
        ...
        <div
          v-else
          class="w-full h-48 bg-gray-200 flex items-center justify-center text-gray-500 rounded"
        >
          No image
        </div>
      </div>
      ...
      <div
        class="w-full md:w-1/2 flex flex-col gap-2 text-gray-700 text-sm justify-start"
      >
    ...
    <div class="flex justify-end mt-4">
      <button
        ...
        @click="openModal"
      >
        {{ post.type_post?.type === "Selling" ? t('btnPlaceBid') : t('btnMakeOffer') }}
      </button>
    </div>
